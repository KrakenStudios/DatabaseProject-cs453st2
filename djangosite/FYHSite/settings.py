...
ADMINS = (
    ('Chris Ward', 'cwardl@polaris.cs.wcu.edu'),
    ('Diego Gonzalez', 'dgonzalez@polaris.cs.wcu.edu'),
    ('Matt Stender', 'mstender@polaris.cs.wcu.edu'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cs453db2',                      # Or path to database file if using sqlite3.
        'USER': 'cs453st2',                      # Not used with sqlite3.
        'PASSWORD': 'batmanondrugs',                  # Not used with sqlite3.
...
SECRET_KEY = 'f3+nn_&#6(e@l*8lxz6vp5p^8d-y34zdl-kr4_m*n*ja+w+o6@'
