...
# Examples:
    ...
    url(r'^account/register/', 'FYHSite.blog.views.register',name='register'),
    ...
    url(r'^account/login/', 'FYHSite.blog.views.login',name='login'),
    ...
    url(r'^account/', 'FYHSite.blog.views.account',name='account'),
)
