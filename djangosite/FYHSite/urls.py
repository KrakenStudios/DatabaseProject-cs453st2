...
urlpatterns = patterns('',
    ...
    url(r'^account/login/', 'FYHSite.site.views.userlogin'),
    url(r'^account/register', 'FYHSite.site.views.registration'),
    url(r'^account/logout', 'FYHSite.site.views.userlogout'),
