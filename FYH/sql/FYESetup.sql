...
#Populate Products
INSERT INTO `cs453db2`.`Products` (`Id`, `UPCCode`,  `ProductBrand`, `ProductType`, `ProductName`, `ProductDescription`, `ProductSellPrice`, `ProductWholesalePrice`, `AmountInStock`, `InStock`) VALUES (NULL, '923547', 'PartyHardy', 'Entertainment', 'WackyFlailingInflatableArmMan', 'WACKYINFLATABLEFLAILINGARMMAN', '299.99', '10', '20', b'1');
INSERT INTO `cs453db2`.`Products` (`Id`, `UPCCode`,  `ProductBrand`, `ProductType`, `ProductName`, `ProductDescription`, `ProductSellPrice`, `ProductWholesalePrice`, `AmountInStock`, `InStock`) VALUES (NULL, '923548', 'PetCo', 'Pets', 'Hermit Crab', 'Its a crab!', '20.00', '5.00', '2000', b'1');
